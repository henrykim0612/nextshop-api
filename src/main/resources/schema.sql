CREATE TABLE users (
    ...
    visit_route CHAR(1) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT ck_gender CHECK (gender IN ('M', 'F')),
    CONSTRAINT ck_visit_route CHECK (visit_route IN ('S', 'A', 'R', 'O')),-- S: 소셜 네트워크, A: 광고, R: 지인 추천, O: 기타
    CONSTRAINT uq_user_email UNIQUE (email)
);

INSERT INTO users (email, password, name, phone, gender, visit_route)
VALUES ('admin@gmail.com', '$2a$10$14Jog3VzjF/X1H.bh4mjIOdYcmdzw17PgAIS8u05wkJZNwXF/FvjS', 'Master Kim', '010-9999-9999', 'M', 'S');
